		...
		<>
			...
			<div>
				...
				<input
					type="password"
					placeholder="********"
					className="flex justify-center absolute top-152 left-116 border rounded-md w-70 h-7 transition-all border-black/10 shadow-lg hover:shadow-xl outline-0 pl-2 text-black placeholder:text-gray-600 focus:ring-2 focus:ring-purple-500 focus:border-transparent
