	...
	return (
		<>
			<header className="flex items-center justify-between px-4 xl:px-20 py-4 text-black">
             ...
             border-black/10 shadow-lg hover:shadow-xl outline-0 sm:relative md:top-0 max-sm:mt-12 max-sm:-ml-3"
					>
				...
				<div className="flex items-center gap-2 xl:gap-3">
					<button className="flex items-center gap-2 border rounded-md px-2 xl:px-3 py-1 transition-all border-black/10 shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 max-sm:mt-12">
						<Search size={16} />
						<span className="hidden xl:inline">Search thread</span>
					</button>

					<button className="flex items-center gap-2 border rounded-md px-2 xl:px-3 py-1 transition-all border-black/10 shadow-lg max-sm:mt-12 hover:shadow-xl hover:scale-105 active:scale-95">
